...
describe("ThemeSettings", () => {
  ...
  it("shows light theme as selected", () => {
    ...
    const lightRadio = radios.find(
      (radio) => (radio as HTMLInputElement).value === "light",
    );
  ...
  it("shows dark theme as selected", () => {
    ...
    const darkRadio = radios.find(
      (radio) => (radio as HTMLInputElement).value === "dark",
    );
  ...
  it("shows system theme as selected", () => {
    ...
    const systemRadio = radios.find(
      (radio) => (radio as HTMLInputElement).value === "system",
    );
