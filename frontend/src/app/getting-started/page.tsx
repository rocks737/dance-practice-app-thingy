        ...
        <main className="flex-1 flex flex-col gap-6">
          ...
          <ol className="list-decimal space-y-4">
            <li className="leading-relaxed">
              Decide if you want to support both personal and team accounts. Personal
              accounts can't be disabled, but you can remove the dashboard sections that
              display them.
              <a
            ...
            <li className="leading-relaxed">
              ...
              <p>
                The CLI isn't required, but it'll help you learn the RLS policy options
                available to you.{" "}
                <a
                  className="border-b mx-2"
            ...
            <li>
              Setup subscription billing. Determine if you want to bill for both personal
              and team accounts, update your{" "}
              <pre className="bg-red-50 px-2 py-1 rounded overflow-hidden text-sm inline">
                basejump.config
              </pre>{" "}
              table accordingly.{" "}
          ...
          <ul className="list-disc space-y-2">
            ...
            <li className="leading-relaxed">
              <a className="border-b mx-2" href="https://usebasejump.com/docs/testing">
                Writing tests on Supabase with pgTAP
              </a>
            </li>
            <li className="leading-relaxed">
              <a className="border-b mx-2" href="https://usebasejump.com/docs/rls">
                Working with RLS Policies in Supabase
              </a>
            </li>
            <li className="leading-relaxed">
              <a className="border-b mx-2" href="https://usebasejump.com/docs/deployment">
